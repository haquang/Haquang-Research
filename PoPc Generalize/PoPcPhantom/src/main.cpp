...
void initData()
{
	PoPcPosChannel.Config(true,true,3); // PoPc in Position command channel - active, modify velocity
	PoPcForceChannel.Config(true,false,3); // PoPc in Force feedback command channel - nonactive
	for(i=0; i < DT-1; i++)
	{
