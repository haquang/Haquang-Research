...
void initData()
{
	PoPcPosChannel.Config(true,false); // PoPc in Position command channel - nonactive
	PoPcForceChannel.Config(false,true); // PoPc in Force feedback command channel - active, modify force
	for (i=0;i<DT-1;i++)
	{
